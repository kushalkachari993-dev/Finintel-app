...
DATABASE_OPERATION_TIMEOUT_SECONDS = float(
    os.getenv("DATABASE_OPERATION_TIMEOUT_SECONDS", "10")
)

DATABASE_CONNECT_RETRIES = int(
    os.getenv("DATABASE_CONNECT_RETRIES", "3")
)

DATABASE_CONNECT_RETRY_DELAY_SECONDS = float(
    os.getenv("DATABASE_CONNECT_RETRY_DELAY_SECONDS", "1")
)
